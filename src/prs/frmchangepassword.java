...
public class frmchangepassword extends javax.swing.JInternalFrame {
    ...
    public String user = dbconnector.uname;
    public int Count;
    ...
    private void txtokActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtokActionPerformed
        try {
            ...
            String currentpassword = txtpass.getText();
            ...
            if (Count > 0) {
                ...
                if (i == 0) {
                    ...
                    dbconnector.ChangeRootPassword(host, user, currentpassword, verpasswrd);
                  //  voidmodule.U_transaction(verpasswrd, "Change password   " + verpasswrd);
